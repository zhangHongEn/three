...
Examples =
{
	...
	fireball :
	{
		...
		particleTexture : textureLoader.load( 'images/smokeparticle.png' ),
	...
	snow :
	{
		...
		particleTexture : textureLoader.load( 'images/snowflake.png' ),
	...
	rain :
	{
		...
		particleTexture : textureLoader.load( 'images/raindrop2flip.png' ),
	...
	starfield :
	{
		...
		particleTexture : textureLoader.load( 'images/spikey.png' ),
	...
	fireflies :
	{
		...
		particleTexture : textureLoader.load( 'images/spark.png' ),
...
Examples.firework.clone = function(params){
	var firework = {};
	for(var property in this){
		firework[property] = this[property];
	}
	for(var property in params){
		firework[property] = params[property];
	}
	return firework;
};