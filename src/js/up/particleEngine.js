...
Particle.prototype.update = function(dt,tweens)
{
	...
	if ( tweens.sizeTween.times.length > 0 )
		this.size = tweens.sizeTween.lerp( this.age );
				
	if ( tweens.colorTween.times.length > 0 )
	{
		var colorHSL = tweens.colorTween.lerp( this.age );
		this.color = new THREE.Color().setHSL( colorHSL.x, colorHSL.y, colorHSL.z );
	}
	
	if ( tweens.opacityTween.times.length > 0 )
		this.opacity = tweens.opacityTween.lerp( this.age );
...
ParticleEngine.prototype.initialize = function()
{
	...
	for (var i = 0,i3=0; i < this.particleCount; i++,i3+=3)
	{
		...
		this.particleGeometry.attributes.position.array[i3] = this.particleArray[i].position.x;
		this.particleGeometry.attributes.position.array[i3+1] = this.particleArray[i].position.y;
		this.particleGeometry.attributes.position.array[i3+2] = this.particleArray[i].position.z;
		this.particleGeometry.attributes.customVisible.array[i] = this.particleArray[i].alive;
		this.particleGeometry.attributes.customColor.array[i3]   = this.particleArray[i].color.r;
		this.particleGeometry.attributes.customColor.array[i3+1]   = this.particleArray[i].color.g;
		this.particleGeometry.attributes.customColor.array[i3+2]   = this.particleArray[i].color.b;
	...
	this.particleMesh.position.set(0,0,0);
...
ParticleEngine.prototype.update = function(dt)
{
	...
	for (var i = 0,i3=0; i < this.particleCount; i++,i3+=3)
	{
		...
		{
			this.particleArray[i].update(dt,this.tweens);
	...
	this.particleGeometry.attributes.customVisible.needsUpdate = 
	this.particleGeometry.attributes.customColor.needsUpdate = 
	this.particleGeometry.attributes.customOpacity.needsUpdate = 
	this.particleGeometry.attributes.customSize.needsUpdate = 
	this.particleGeometry.attributes.customAngle.needsUpdate = 
	...
	for (var j = 0,j3=0; j < recycleIndices.length; j++,j3+=3)
	{
		var i = recycleIndices[j];
		this.particleArray[i] = this.createParticle();
		this.particleArray[i].alive = 1.0; // activate right away
		this.particleGeometry.attributes.position.array[j3] = this.particleArray[i].position.x;
		this.particleGeometry.attributes.position.array[j3+1] = this.particleArray[i].position.y;
		this.particleGeometry.attributes.position.array[j3+2] = this.particleArray[i].position.z;
	}
